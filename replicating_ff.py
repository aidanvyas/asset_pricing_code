"""
TODO: Optimize around high correlation with Fama-French
        Evaluate restrictions in the nyse_hml, apply functions for the breakpoints, and then for ccm4.
        Investigate MIB / MII

TODO: Reorganize Code 
    Process Data, Replicate Fama-French, and Construct_Value_Metrics
TODO: Simplify Fama-French factor functions (seem what can be abstracted if any)
TODO: Simplify non-Fama French addtions


TODO: Decile Sorts
TODO: Fama-MacBeth Regressions
...
def compare_with_fama_french():
    ...
    ff_replicated = ffcomp63[['date', 'xRm-Rf', 'xSMB', 'xHML', 'xRMW', 'xCMA']]
